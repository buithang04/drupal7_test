    ...
    function loadBacklinkDetail() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                let currentDiv = $("tr[data-nid=568]");
            }
        });
    }
    ...
    $("document").ready(function(e) {
      ...
      async function getTelsResponse(currentObj,responseObject,running){
        ...
        if(responseObject.status===200){
          ...
          let body = dom_nodes.find("head");
          let footer = dom_nodes.find("footer");
          let aNodes = dom_nodes.find("a[href^='tel:']");

          // console.log("body",responseObject);
          let splitter1 = responseText.split("<body");
          // console.log("splitter1",splitter1);
          footerText = splitter1[1];
          // console.log("footerText",footerText);
          // return;
          // return;
          // footerText = footer.text()+aNodes.text();
